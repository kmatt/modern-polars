...
You can install the exact packages that the book uses with the [pyproject.toml](https://github.com/kevinheavey/modern-polars/blob/master/pyproject.toml) file:

```shell
uv sync
```

If you're not using uv you can install the following package versions and it should work:
