...
According to the [`memray`](https://github.com/bloomberg/memray) profiler, the Dask example's memory usage peaks at 4.0 GB, while Polars peaks at 2.3 GB.
...
cm_pl = (
    ...
    .group_by("CMTE_ID", maintain_order=True)
    .last()
)
